...
async function main() {
  const vkPath = path.resolve(__dirname, '../../circuits/verification_key_update.json');
...
`;
  ...
  fs.writeFileSync(path.resolve(__dirname, '../../src/zNEP17.Verifier/VerificationKey.TreeUpdate.cs'), csContent);
